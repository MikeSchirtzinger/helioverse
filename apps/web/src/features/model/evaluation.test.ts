...
const cme = (index: number, linkedEventIds: string[] = []): DonkiCme => ({
  ...
  enlilDurationH: 12,
  enlilModelCompletionIso: '2024-05-10T06:00:00Z',
  enlilRunLink: 'https://kauai.ccmc.gsfc.nasa.gov/DONKI/view/WSA-ENLIL/1/1',
  enlilCmeIds: [`2024-05-10T00:00:00-CME-${String(index).padStart(3, '0')}`],
  hasEnlilRun: true,
  earthImpactClassification: 'direct',
  isEarthGlancingBlow: false,
  isEarthMinorImpact: false,
  isEarthDirected: true,
  predictedKpRange: { min: 7, max: 7 },
  predictedKp: 7,
  linkedEventIds,
  estMass_kg: 1e12,
  estIons: 1e39,
